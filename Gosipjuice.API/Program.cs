...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("GosipjuiceConnectionString"));
});
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("Gosipjuice")
